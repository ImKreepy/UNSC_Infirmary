...
[_patient, "activity", QUOTE(%1 used %2 on the patient), [[_medic, false, true] call ACEFUNC(common,getName), "[UNSCI] Biomedical Foam"]] call ACEFUNC(medical_treatment,addToLog);
