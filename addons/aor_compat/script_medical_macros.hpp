#define AOR_BIOFOAM_INJURIES class AOR_PlasmaBurn { \
    effectiveness = 1;  \
    reopeningChance = 0.2;  \
...
#define AOR_MEDIGEL_INJURIES class AOR_PlasmaBurn { \
    effectiveness = 5;  \
    reopeningChance = 0.6;  \
...
#define AOR_MEDKIT_INJURIES class AOR_PlasmaBurn {  \
    effectiveness = 10; \
    reopeningChance = 0.3;  \
    reopeningMinDelay = 50; \
    reopeningMaxDelay = 100;    \
...
#define KILL_WOUND_TYPES_AOR class AOR_BlamiteWound { \
    effectiveness = 0;    \
    reopeningChance = 1;  \
    reopeningMinDelay = 1; \
    reopeningMaxDelay = 1;    \
};    \
class AOR_BlamiteWoundMinor : AOR_BlamiteWound {};  \
class AOR_BlamiteWoundMedium : AOR_BlamiteWound {}; \
class AOR_BlamiteWoundLarge : AOR_BlamiteWound {};  \
class AOR_SpikeWound : AOR_BlamiteWound {};  \
class AOR_SpikeWoundMinor : AOR_SpikeWound {};  \
class AOR_SpikeWoundMedium : AOR_SpikeWound {}; \
class AOR_SpikeWoundLarge : AOR_SpikeWound {}
